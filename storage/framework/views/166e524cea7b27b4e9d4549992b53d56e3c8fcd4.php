                                        ...
                                        <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td class="text-center">
                                                <?php switch($feature):
                                                    ...
                                                    <?php case (__('Client Limit')): ?>
                                                        <?php echo e($subscription->client_limit); ?>

                                                    <?php break; ?>

                                                    <?php case (__('Employee Limit')): ?>
                                                        <?php echo e($subscription->employee_limit); ?>
                                                    ...
                                                    <?php case (__('Enabled Logged History')): ?>
                                                        ...
                                                        <?php endif; ?>
                                                    <?php break; ?>
                                                    <?php case (__('Enabled Open Ai Support')): ?>
                                                        <?php if($subscription->enabled_openai): ?>
                                                            <div class="bg-success text-white avtar avtar-xs icon">
                                                                <i class="ti ti-check f-20"></i>
                                                            </div>
                                                        <?php else: ?>
                                                        ...
                                                        <?php endif; ?>
                                                    <?php break; ?>
                                                    <?php case (__('Enabled N8n')): ?>
                                                        <?php if($subscription->enabled_n8n): ?>
                                                            <div class="bg-success text-white avtar avtar-xs icon">
                                                                <i class="ti ti-check f-20"></i>
                                                            </div>
                                                        <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\main_file\resources\views/subscription/index.blade.php ENDPATH**/ ?>