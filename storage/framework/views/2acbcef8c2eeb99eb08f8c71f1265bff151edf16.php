                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-2 col-lg-3">
                            <?php echo e(Form::label('invoice_id', __('Invoice ID'), ['class' => 'form-label'])); ?>

                            <?php echo e(Form::text('invoice_id', invoicePrefix() . $invoiceId, ['class' => 'form-control', 'required' => 'required', 'readonly'])); ?>

                        </div>
                        <div class="form-group col-md-2 col-lg-3">
                            <?php echo e(Form::label('invoice_date', __('Invoice Date'), ['class' => 'form-label'])); ?>
                        ...
                        <div class="form-group col-md-3 col-lg-3">
                            ...
                            <?php echo e(Form::select('client', $clients, null, ['class' => 'form-control select2', 'id' => 'client_id', 'required' => 'required'])); ?>

                        </div>
                        <div class="form-group col-md-3 col-lg-3">
                            <?php echo e(Form::label('service_id', __('Service'), ['class' => 'form-label'])); ?>

                            <div class="service_div">
                                <?php echo Form::select('service', $services ?? [], null, [
            ...
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a class="btn btn-secondary d-flex align-items-center gap-2" href="#" data-repeater-create="">
                        <i class="ti ti-circle-plus align-text-bottom"></i><?php echo e(__('Add Service Type')); ?></a>
                </div>
            </div>
            <div class="card-body">
                <table class="display dataTable cell-border">
                    ...
                    <tbody data-repeater-list="types">
                        <tr data-repeater-item>
                            <td width="30%">
                                <?php echo Form::select('types[INDEX][service_type]', $types, null, [
                            ...
                            <td>
                                <?php echo e(Form::text('types[INDEX][rate]', null, ['class' => 'form-control rate', 'readonly' => true])); ?>

                            </td>

                            <td width="30%">
                                <?php echo Form::select('types[INDEX][tax][]', $taxs, null, [
                            ...
                            <td>
                                <?php echo e(Form::textarea('types[INDEX][note]', null, [
                        ...
                        <div class="card-body">
                            <div class="row location_list">
                                <div class="form-group col-md-3 col-lg-3">
                                    ...
                                    <?php echo Form::select('item[0]', $items, null, [
                                ...
                                <div class="form-group col-md-1 col-lg-1">
                                    ...
                                    <?php echo e(Form::number('quantity[0]', null, ['class' => 'form-control quantity', 'required' => 'required'])); ?>

                                </div>
                                <div class="form-group col-md-1 col-lg-1">
                                    <?php echo e(Form::label('amount', __('Amount'), ['class' => 'form-label'])); ?>

                                    <?php echo e(Form::number('amount[0]', null, ['class' => 'form-control amount', 'step' => '0.01', 'required' => 'required'])); ?>

                                </div>
                                <div class="form-group col-md-2 col-lg-2">
                                    <?php echo e(Form::label('tax', __('Tax'), ['class' => 'form-label'])); ?>

                                    <?php echo Form::select('tax[0][]', $taxs, null, [
                                ...
                                <div class="form-group col-md-4 col-lg-4">
                                    ...
                                    <?php echo e(Form::textarea('description[0]', null, ['class' => 'form-control description', 'rows' => 2])); ?>
...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        $('#client_id').on('change', function() {
            ...
            if (client_id) {
                var url = '<?php echo e(route('client.service', ':id')); ?>';
                ...
                $('.service').empty().append('<option value=""><?php echo e(__('Select Service')); ?></option>');
        ...
        $(document).on('change', '#service', function() {
            ...
            if (service_id) {
                ...
                var url = '<?php echo e(route('get.service.type', ':id')); ?>';
                    ...
                    <tr data-repeater-item>
                        ...
                        <td width="30%">
                            <select name="types[INDEX][tax][]" class="form-control select2 tax" multiple>
                                <?php $__currentLoopData = $taxs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $tax_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($id); ?>"><?php echo e($tax_name); ?></option>
    ...
    <script>
        $(document).on('change', '#item_id', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('invoice.item')); ?>",
                type: 'post',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\main_file\resources\views/invoice/create.blade.php ENDPATH**/ ?>