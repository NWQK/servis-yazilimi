                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6 col-xl-6">
                        <h1 class="mt-sm-3 mb-sm-4 f-w-600 wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <?php else: ?>
                                <?php echo e(__('Service Hub - Vehicle Repair Center Management')); ?>
                        ...
                        <h4 class="mb-sm-4 text-muted wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <?php else: ?>
                                <?php echo e(__('Service Hub Management System is a robust software platform tailored to the needs of automotive repair shops, garages, and workshops. It provides an integrated solution to effectively manage day-to-day operations, enhance productivity, and improve customer satisfaction.')); ?>
                                ...
                                <div class="card price-card ">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush product-list">
                                            ...
                                            <li class="list-group-item enable"><?php echo e(__('Employee Limit')); ?>

                                                <?php echo e($subscription->employee_limit); ?></li>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <?php else: ?>
                                    <div class="swiper-slide">
                                        ...
                                        <p><?php echo e(__('Service Hub Management System is a robust software platform tailored to the needs of automotive repair shops, garages, and workshops.')); ?>
...
<?php /**PATH C:\xampp\htdocs\main_file\resources\views/layouts/landing.blade.php ENDPATH**/ ?>