                            ...
                            <div class="tab-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::text('copyright', !empty($settings['copyright']) ? $settings['copyright'] : '', ['class' => 'form-control', 'placeholder' => __('Enter your application name'), 'required' => 'required'])); ?>
                                ...
                                <?php if(Gate::check('manage company settings')): ?>
                                    <div class="tab-pane <?php echo e(!empty($activeTab) && $activeTab == 'company_settings' ? ' active show ' : ''); ?>"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('client_number_prefix', __('Client Number Prefix'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('client_number_prefix', $settings['client_number_prefix'], ['class' => 'form-control', 'placeholder' => __('Enter client number prefix')])); ?>

                                            </div>
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('employee_number_prefix', __('Employee Number Prefix'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('employee_number_prefix', $settings['employee_number_prefix'], ['class' => 'form-control', 'placeholder' => __('Enter employee number prefix')])); ?>

                                            </div>
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('vehicle_number_prefix', __('Vehicle Number Prefix'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('vehicle_number_prefix', $settings['vehicle_number_prefix'], ['class' => 'form-control', 'placeholder' => __('Enter vehicle number prefix')])); ?>

                                            </div>
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('service_number_prefix', __('Service Number Prefix'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('service_number_prefix', $settings['service_number_prefix'], ['class' => 'form-control', 'placeholder' => __('Enter service number prefix')])); ?>

                                            </div>
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('quotation_number_prefix', __('Quotation Number Prefix'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('quotation_number_prefix', $settings['quotation_number_prefix'], ['class' => 'form-control', 'placeholder' => __('Enter service number prefix')])); ?>
                                ...
                                <?php if(Gate::check('manage payment settings')): ?>
                                    <div class="tab-pane <?php echo e(!empty($activeTab) && $activeTab == 'payment_settings' ? ' active show ' : ''); ?>"
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-auto">
                                                <?php echo e(Form::label('razorpay_payment', __('Razorpay Payment'), ['class' => 'form-label'])); ?>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-check custom-chek">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            <?php echo e($settings['razorpay_payment'] == 'on' ? 'checked' : ''); ?>>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('razorpay_public_key', __('Public Key'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('razorpay_public_key', $settings['razorpay_public_key'], ['class' => 'form-control', 'placeholder' => __('Enter Razorpay public key')])); ?>

                                            </div>
                                            <div class="form-group col-md-6">
                                                <?php echo e(Form::label('razorpay_secret_key', __('Secret Key'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('razorpay_secret_key', $settings['razorpay_secret_key'], ['class' => 'form-control', 'placeholder' => __('Enter Razorpay  secret key')])); ?>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php echo e(Form::text('meta_seo_description', $settings['meta_seo_description'], ['class' => 'form-control', 'placeholder' => __('Enter meta SEO description'), 'required' => 'required', 'rows' => '2'])); ?>
                                ...
                                <?php if(Gate::check('manage twilio settings')): ?>
                                    <div class="tab-pane <?php echo e(!empty($activeTab) && $activeTab == 'twilio' ? ' active show ' : ''); ?>"
                                        ...
                                        <div class="row mt-3">
                                            <div class="form-group col-md-12">
                                                <?php echo e(Form::label('twilio_whatsapp_number', __('WhatsApp From Number'))); ?>

                                                <?php echo e(Form::text('twilio_whatsapp_number', $settings['twilio_whatsapp_number'] ?? '', [
                                                    'class' => 'form-control',
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage openai settings')): ?>
                                    <div class="tab-pane <?php echo e(!empty($activeTab) && $activeTab == 'openai' ? ' active show ' : ''); ?>"
                                        ...
                                        <?php echo e(Form::model($settings, ['route' => ['openai.settings'], 'method' => 'POST'])); ?>

                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <?php echo e(Form::label('openai_secret_key', __('Open ai secret key'), ['class' => 'form-label'])); ?>

                                                <?php echo e(Form::text('openai_secret_key', $settings['openai_secret_key'] ?? null, [
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <?php echo e(Form::label('openai_module', __('Enable OpenAI Module'), ['class' => 'form-label'])); ?>

                                                    <div class="flex-shrink-0">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="openai_module" name="openai_module"
                                                                <?php echo e($settings['openai_module'] == 'on' ? 'checked' : ''); ?>>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\main_file\resources\views/settings/index.blade.php ENDPATH**/ ?>