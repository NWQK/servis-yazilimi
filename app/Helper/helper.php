    ...
    function MessageReplace($notification, $id = 0)
    {
        ...
        if (!empty($notification)) {
            ...
            if ($notification->module == 'vehicle_create') {
                ...
                $replace = [$settings['company_name'], $settings['company_email'], $settings['company_phone'], $settings['company_address'], $settings['CURRENCY_SYMBOL'], $vehicle->clients->name, vehiclePrefix() . $vehicle->vehicle_id, $vehicle->types->type, $vehicle->brands->name, $vehicle->model, $vehicle->color, $vehicle->license_plate, $vehicle->engine_type, $vehicle->fuel_type, $vehicle->mileage, dateFormat($vehicle->last_service_date), dateFormat($vehicle->next_service_due_date), $vehicle->insurance_details];
            }
            if ($notification->module == 'service_create') {
                ...
                $replace = [$settings['company_name'], $settings['company_email'], $settings['company_phone'], $settings['company_address'], $settings['CURRENCY_SYMBOL'], $service->clients->name, vehiclePrefix() . $vehicle->vehicle_id, $vehicle->types->type, $vehicle->brands->name, $vehicle->model, $vehicle->license_plate, $vehicle->engine_type, $vehicle->fuel_type, dateFormat($vehicle->last_service_date), $service->assigns->name, $service->assigns->email, $service->assigns->phone_number, $service->status];
            }
            if ($notification->module == 'service_assign') {
                ...
                $replace = [$settings['company_name'], $settings['company_email'], $settings['company_phone'], $settings['company_address'], $settings['CURRENCY_SYMBOL'], $service->assigns->name, vehiclePrefix() . $vehicle->vehicle_id, $vehicle->types->type, $vehicle->brands->name, $vehicle->model, $vehicle->license_plate, $vehicle->engine_type, $vehicle->fuel_type, dateFormat($vehicle->last_service_date), $service->clients->name, $service->clients->email, $service->clients->phone_number, $service->status];
            }
