(function () {
    ...
    var calendar = new FullCalendar.Calendar(
        document.getElementById("calendar"),
        {
            ...
            eventClick: function (info) {
                ...
                var e_assign = clickedevent.extendedProps.assign || "-";
    ...
    if (pc_event_edit) {
        pc_event_edit.addEventListener("click", function () {
            var e_title =
                calendevent.title === undefined ? "" : calendevent.title;
            var e_desc =
                calendevent.extendedProps.description === undefined
                    ? ""
                    : calendevent.extendedProps.description;
            var e_date_start =
                calendevent.start === null ? "" : dateformat(calendevent.start);
            var e_date_end =
                calendevent.end === null
                    ? ""
                    : " <i class='text-sm'>to</i> " +
                      dateformat(calendevent.end);
            e_date_end = calendevent.end === null ? "" : e_date_end;
            var e_venue =
                calendevent.extendedProps.description === undefined
                    ? ""
                    : calendevent.extendedProps.venue;
            var e_type =
                calendevent.classNames[0] === undefined
                    ? ""
                    : calendevent.classNames[0];
            ...
            document.getElementById("pc-e-edate").value =
                ...
                getRound(edt.getDate());
            document.getElementById("pc-e-btn-text").innerHTML =
                '<i class="align-text-bottom me-1 ti ti-calendar-stats"></i> Update';
            document
                .querySelector("#pc_event_add")
                .setAttribute("data-pc-action", "edit");
            calendarmodal.hide();
            //   calendaroffcanvas.show();
        });
    }
