{{ Form::open(['url' => 'vehicle-brand', 'method' => 'post']) }}
<div class="modal-body">
    ...
    @if (settings()['openai_module'] == 'on' &&
        ...
        <div class="text-end">
            <a href="javascript:void(0)" class="btn btn-primary mb-2 aiModal" data-size="lg"
                data-url="{{ route('generate.template', ['vehicle_brand']) }}"
    ...
    <div class="row">
        <div class="form-group col-md-12">
            {{ Form::label('name', __('Model'), ['class' => 'form-label']) }}
            {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => __('Enter model'), 'required' => 'required']) }}
        </div>
        <div class="form-group col-md-12">
