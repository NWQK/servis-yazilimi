                            ...
                            <div class="tab-content">
                                ...
                                @if (Gate::check('manage company settings'))
                                    <div class="tab-pane {{ !empty($activeTab) && $activeTab == 'company_settings' ? ' active show ' : '' }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                {{ Form::label('employee_number_prefix', __('Employee Number Prefix'), ['class' => 'form-label']) }}
                                                {{ Form::text('employee_number_prefix', $settings['employee_number_prefix'], ['class' => 'form-control', 'placeholder' => __('Enter employee number prefix')]) }}
                                            </div>
                                            <div class="form-group col-md-6">
                                                {{ Form::label('vehicle_number_prefix', __('Vehicle Number Prefix'), ['class' => 'form-label']) }}
                                                {{ Form::text('vehicle_number_prefix', $settings['vehicle_number_prefix'], ['class' => 'form-control', 'placeholder' => __('Enter vehicle number prefix')]) }}
                                            </div>
                                            <div class="form-group col-md-6">
                                                {{ Form::label('service_number_prefix', __('Service Number Prefix'), ['class' => 'form-label']) }}
                                                {{ Form::text('service_number_prefix', $settings['service_number_prefix'], ['class' => 'form-control', 'placeholder' => __('Enter service number prefix')]) }}
                                            </div>
                                            <div class="form-group col-md-6">
                                                {{ Form::label('quotation_number_prefix', __('Quotation Number Prefix'), ['class' => 'form-label']) }}
                                                {{ Form::text('quotation_number_prefix', $settings['quotation_number_prefix'], ['class' => 'form-control', 'placeholder' => __('Enter service number prefix')]) }}
                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    {{ Form::text('meta_seo_description', $settings['meta_seo_description'], ['class' => 'form-control', 'placeholder' => __('Enter meta SEO description'), 'required' => 'required', 'rows' => '2']) }}
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                ...
                                @can('manage openai settings')
                                    <div class="tab-pane {{ !empty($activeTab) && $activeTab == 'openai' ? ' active show ' : '' }}"
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                {{ Form::label('openai_secret_key', __('Open ai secret key'), ['class' => 'form-label']) }}
                                                {{ Form::text('openai_secret_key', $settings['openai_secret_key'] ?? null, [
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" type="checkbox"
                                                                ...
                                                                {{ $settings['openai_module'] == 'on' ? 'checked' : '' }}>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
