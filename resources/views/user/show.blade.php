                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    @foreach ($subscriptions as $subscription_key => $subscription)
                                                        ...
                                                        <ul class="gap-2 mt-3 plan_change_info customCheckdef{{ $subscription_key }}"
                                                            ...
                                                            <li>{{ __('Client Limit') }} {{ $subscription->client_limit }}
                                                            </li>
                                                            <li>{{ __('Employee Limit') }}
                                                            ...
                                                            @endif
                                                            @if ($subscription->enabled_openai)
                                                                <li>{{ __('Enabled') }} {{ __('Open Ai Support') }}
                                                                </li>
                                                            @else
                                                                <li>{{ __('Disable') }} {{ __('Open Ai Support') }}
                                                                </li>
                                                            @endif
                                                            @if ($subscription->enabled_n8n)
                                                                <li>{{ __('Enabled') }} {{ __('N8n') }}
                                                                </li>
                                                            @else
                                                                <li>{{ __('Disable') }} {{ __('N8n') }}
                                                                </li>
                                                            @endif
                                                        </ul>
                                                    @endforeach
